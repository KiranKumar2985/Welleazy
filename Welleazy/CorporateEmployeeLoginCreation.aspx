<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="CorporateEmployeeLoginCreation.aspx.cs" Inherits="Welleazy.Admin.CorporateEmployeeLoginCreation" %>
               ...
               <asp:View ID="Save" runat="server">
                           ...
                           <div class="form-group">
                               <%--<div class="col-md-3">
                                   ...
                                   <div class="selector">
                                       <telerik:RadComboBox ID="cmbSubRole" AutoPostBack="true" runat="server" RenderMode="Lightweight" AppendDataBoundItems="true" Filter="Contains" OnSelectedIndexChanged="cmbSubRole_SelectedIndexChanged">
                                           <Items>
                                               <telerik:RadComboBoxItem Value="0" Text="-Select-" />
                                               <telerik:RadComboBoxItem Value="1" Text="Management" />
                                               <telerik:RadComboBoxItem Value="2" Text="DOCTOR" />
                                               <telerik:RadComboBoxItem Value="3" Text="Human Resource" />
                                           </Items>
                                       </telerik:RadComboBox>
                                   </div>
                               </div>--%>
                               ...
                               <div class="col-md-3">
                                   ...
                                   <div class="selector">
                                       <telerik:RadComboBox ID="cmbCorporateName" RenderMode="Lightweight" CausesValidation="false" CssClass="Combo" AutoPostBack="true" runat="server" AppendDataBoundItems="true" OnSelectedIndexChanged="cmbCorporateName_SelectedIndexChanged" Filter="Contains">
                                                <Items>
                                               <telerik:RadComboBoxItem Value="0" Text="-Select-" />
                                           </Items>
                                            </telerik:RadComboBox>
                               ...
                               <div class="col-md-3">
                                   ...
                                   <div class="selector">
                                       <telerik:RadComboBox ID="cmbCorporateBranch" RenderMode="Lightweight" CausesValidation="false" CssClass="Combo" AutoPostBack="true" runat="server" AppendDataBoundItems="true" OnSelectedIndexChanged="cmbCorporateBranch_SelectedIndexChanged" Filter="Contains">
                                                <Items>
                                               <telerik:RadComboBoxItem Value="0" Text="-Select-" />
                                           </Items>
                                            </telerik:RadComboBox>
                                       <asp:RequiredFieldValidator ID="rfvCorporateBranch" runat="server" ControlToValidate="cmbCorporateBranch" ForeColor="Red" InitialValue="-Select-" ErrorMessage="Select Corporate Branch"></asp:RequiredFieldValidator>
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <label>
                                   ...
                                   <div class="selector">
                                       <telerik:RadComboBox ID="cmbEmployeeName" RenderMode="Lightweight" CausesValidation="false" CssClass="Combo" AutoPostBack="true" OnSelectedIndexChanged="cmbEmployeeName_SelectedIndexChanged" runat="server" AppendDataBoundItems="true" Filter="Contains">
                                                <Items>
                                               <telerik:RadComboBoxItem Value="0" Text="-Select-" />
                                           </Items>
                                            </telerik:RadComboBox>
                                       <asp:RequiredFieldValidator ID="rfvEmployeeName" runat="server" ControlToValidate="cmbEmployeeName" ForeColor="Red" InitialValue="-Select-" ErrorMessage="Select Employee Name"></asp:RequiredFieldValidator>
                               ...
                               <div class="col-md-3" runat="server" id="InputPassword" visible="false">
                                   <label>
                           ...
                           <div class="form-group" style="overflow:auto; width:100%; padding:10px;">
                            ...
                            CellPadding="4" BorderColor="#000066" BorderStyle="Solid" BorderWidth="2px" Skin="Bootstrap" HeaderStyle-BackColor="#113d7a" HeaderStyle-ForeColor="White" OnItemDataBound="rgvDefaultRoleTasks_ItemDataBound">
                    ...
                    <asp:Label ID="lblProcessHeader" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Permission")%>' ></asp:Label>
                           ...
                           <tr>
                               ...
                               <td>
                                   <asp:Button ID="btnCancel" runat="server" CausesValidation="false" CssClass="Login_btn btn" BackColor="#113d7a" ForeColor="white" BorderStyle="None" OnClick="btnCancel_Click" Text="Cancel" />
                               </td>
                           </tr>
                       </table>
                           </div>                            
