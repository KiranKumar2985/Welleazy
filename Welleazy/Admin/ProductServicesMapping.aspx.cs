...
{
    public partial class ProductServicesMapping : System.Web.UI.Page
    {
           ...
           else
           {
               ...
               if (btnSave.Text.Equals("Save"))
               {
                   BusinessAccessLayer.InsertUpdateServicesAssigned(0, Convert.ToInt32(cmbLoginType.SelectedValue),
                       Convert.ToInt32(cmbCorporateName.SelectedValue), Convert.ToInt32(cmdBranchId.SelectedValue), ProductList, strTasks,
