...
namespace Welleazy.MasterPages
{
    public partial class Corporate : System.Web.UI.MasterPage
    {
        ...
        public void LoadUserAccessRoles()
        {
            ...
            {
                ViewProfile.Style.Add("Display", "Block");
                UploadEmployeeDetails.Style.Add("Display", "Block");
                ProductSubscription.Style.Add("Display", "Block");
            }
            else
            {
                AddCorporates.Style.Add("Display", "Block");
                UploadEmployeeDetails.Style.Add("Display", "Block");
                ProductSubscription.Style.Add("Display", "Block");
            }
