<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="AddSpecialConsultantCase.aspx.cs" Inherits="Welleazy.Case.AddSpecialConsultantCase" %>
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
           ...
           <h4>Case Management </h4>
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <telerik:RadComboBox ID="cmbAssignExecutive" runat="server" RenderMode="Lightweight" CssClass="Combo" AppendDataBoundItems="true" Filter="Contains" ValidationGroup="Test">
                                <Items>
                            ...
                            <asp:RequiredFieldValidator ID="rfvExecutive" runat="server" ControlToValidate="cmbAssignExecutive" ForeColor="Red" ErrorMessage="Please Select Executive" Enabled="true" ValidationGroup="Test" InitialValue="Select Executive"></asp:RequiredFieldValidator>
                         </div>
                    </div>
            <div class="col-lg-3 col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            <telerik:RadComboBox ID="cmbCorporateName" RenderMode="Lightweight" Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" DataTextField="CorporateName" DataValueField="CorporateId" ValidationGroup="Test">
                                <Items>
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            <telerik:RadComboBox ID="cmbCorporateBranchId" RenderMode="Lightweight" Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" ValidationGroup="Test">
                                <Items>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <asp:TextBox ID="txtMobileNo" runat="server" TextMode="SingleLine" class="form-control required" ValidationGroup="Test"></asp:TextBox>
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <asp:TextBox ID="txtEmployeeName" runat="server" TextMode="SingleLine" class="form-control required" ValidationGroup="Test"></asp:TextBox>
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <telerik:RadComboBox ID="cmbGender" RenderMode="Lightweight"  Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" ValidationGroup="Test">
                                <Items>
           ...
           <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="rfvNoOfFreeConsultation" runat="server" ControlToValidate="txtNoOfFreeConsultations" ForeColor="Red" ErrorMessage="Please Enter No of Free Consultation" Enabled="true" ValidationGroup="Test"></asp:RequiredFieldValidator>
                           </div>
                    </div>
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="rfvConsultationRecord" runat="server" ControlToValidate="txtNoOfConsultationRecorded" ForeColor="Red" ErrorMessage="Please Enter Consultation Recorded" Enabled="true" ValidationGroup="Test"></asp:RequiredFieldValidator>
            ...
            <div class="col-lg-3 col-sm-6">
             ...
             <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPaymentType" runat="server" ControlToValidate="cmbPaymentType" InitialValue="Select Payment Type" ForeColor="Red" ErrorMessage="Please Select Payment Type" Enabled="true" ValidationGroup="Test"></asp:RequiredFieldValidator>
                        </div>
                    </div>
             ...
             <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <telerik:RadComboBox ID="cmbCaseFor" RenderMode="Lightweight" Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" ValidationGroup="Test">
                                <Items>
             ...
             <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="rfvCustomerProfile" runat="server" ControlToValidate="cmbCustomerProfile" InitialValue="Select Cuutomer Profile" ForeColor="Red" ErrorMessage="Please Select Customer Profile" Enabled="true" ValidationGroup="Test"></asp:RequiredFieldValidator>
                        </div>
                    </div>
         ...
         <div class="row">
           ...
           <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <telerik:RadComboBox ID="cmbLanguage" RenderMode="Lightweight" Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" ValidationGroup="Test">
                                <Items>
         ...
         <div class="row">
           ...
           <div class="col-lg-3 col-sm-6">
             ...
             <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                             <telerik:RadDateTimePicker ID="dtpFollowUp" RenderMode="Lightweight" Filter="Contains" CssClass="Combo" runat="server" AppendDataBoundItems="true" ValidationGroup="Test">
