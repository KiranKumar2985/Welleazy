<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AppointmentList.aspx.cs" Inherits="Welleazy.Case.AppointmentList" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none;">
        <h5>
            <asp:LinkButton ID="LinkHome" runat="server" PostBackUrl="~/Home.aspx"  ForeColor="#0033cc">Home</asp:LinkButton> >> Case Management >> Appointment List
             <span style="float:right; font-size:small;">
                    <asp:LinkButton ID="Linkspl1" runat="server" PostBackUrl="~/Appointment/AppointmentHistory.aspx" ForeColor="#0033cc"><b><i class="glyphicon glyphicon-plus"></i></b> Appointment History</asp:LinkButton> 
                 <asp:Label ID="lblCheckAppointmentStatus" runat="server" Visible="false"></asp:Label>
             </span>
        </h5>
                                   <div class="line"></div>
              ...
              <telerik:RadGrid ID="rgAppointmentDetails" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnItemCommand="rgAppointmentDetails_ItemCommand" OnPageIndexChanged="rgAppointmentDetails_PageIndexChanged" OnNeedDataSource="rgAppointmentDetails_NeedDataSource" OnItemDataBound="rgAppointmentDetails_ItemDataBound" Skin="Bootstrap" HeaderStyle-BackColor="#113d7a" HeaderStyle-ForeColor="White">
                  ...
                  <MasterTableView AllowMultiColumnSorting="true" AllowSorting="true">
                           <Columns>
                               ...
                               <telerik:GridTemplateColumn HeaderText="Customer_Number" SortExpression="EmployeeMobileNo">
                                   <ItemTemplate>
