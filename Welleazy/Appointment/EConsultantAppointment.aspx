<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="EConsultantAppointment.aspx.cs" Inherits="Welleazy.Appointment.EConsultantAppointment" %>


<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Case Management | Add E-Consultant Appointment</title>
    ...
    <%--<asp:UpdatePanel ID="upEConsultant" runat="server">
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
        ...
        <%-- </h5>--%>
         ...
         <asp:MultiView ID="EConultantApointmentView" runat="server">
