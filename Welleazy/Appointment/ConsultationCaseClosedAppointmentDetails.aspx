<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="ConsultationCaseClosedAppointmentDetails.aspx.cs" Inherits="Welleazy.Appointment.ConsultationCaseClosedAppointmentDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Case Management | Consultation Case Closed Appointment List</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upConsultationCase" runat="server">
                  <ContentTemplate>
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
        <h5>
            Home >> Case Management >> <asp:LinkButton ID="lnlAppointmentList" runat="server" OnClick="lnlAppointmentList_Click" ForeColor="#0033cc">Case List</asp:LinkButton> >> Consultation Case Closed Appointment List </h5>
         ...
         <div runat="server" id="AdvancedSearch" visible="false" class="form-group" style="padding:10px; padding-top:20px; margin-top:-20px; margin-bottom:240px;">
            ...
            <div class="col-md-3">
             ...
             <div class="col-md-4">
                        ...
                        <div class="selector">
                            <telerik:RadDateRangePicker ID="rdrpFollowupdate" RenderMode="Lightweight" StartDatePicker-DateInput-DateFormat="dd-MM-yyyy" EndDatePicker-DateInput-DateFormat="dd-MM-yyyy" runat="server" ></telerik:RadDateRangePicker>
             ...
             <div class="col-md-4">
                        <label>Case Effective Date (DD-MM-YYYY) </label>
                        <div class="selector">
                            <telerik:RadDateRangePicker ID="rdrpCaseEffectivedate" RenderMode="Lightweight" StartDatePicker-DateInput-DateFormat="dd-MM-yyyy" EndDatePicker-DateInput-DateFormat="MM-dd-yyyy" runat="server"></telerik:RadDateRangePicker>
                            </div>
                        <br />
                    </div>
             <div class="col-md-3">
         ...
         <asp:MultiView ID="EConultantCloseApointmentView" runat="server">
             <asp:View ID="View" runat="server">
                 ...
                 <div class="form-group" style="padding:10px; padding-top:20px; margin-top:40px;  border:3px solid #e1e1e1; border-bottom-style:none; border-left-style:none; border-right-style:none; overflow:auto;">
                     <telerik:RadGrid ID="rgvConsultationCaseClosedAppointmentDetails" runat="server" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" 
                         BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableTheming="true" 
                         HeaderStyle-BackColor="#113d7a" HeaderStyle-ForeColor="White" OnItemCommand="rgvConsultationCaseClosedAppointmentDetails_ItemCommand" OnNeedDataSource="rgvConsultationCaseClosedAppointmentDetails_NeedDataSource"
                         OnPageIndexChanged="rgvConsultationCaseClosedAppointmentDetails_PageIndexChanged" Skin="Bootstrap">
                             ...
                             <Columns>
                                 <telerik:GridTemplateColumn HeaderText="Case Id" SortExpression="CaseId">
                                     <ItemTemplate>
                                         ...
                                         <asp:Label ID="lblConsultationCaseAppointmentDetailsId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ConsultationCaseAppointmentDetailsId")%>' Visible="false"></asp:Label>
                                     </ItemTemplate>
