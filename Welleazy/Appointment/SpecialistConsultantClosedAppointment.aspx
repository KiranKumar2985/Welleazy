<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="SpecialistConsultantClosedAppointment.aspx.cs" Inherits="Welleazy.Appointment.SpecialistConsultantClosedAppointment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Case Management | Specalities Consultant Closed Appointment List</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upEConsultant" runat="server">
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
         ...
         <br />
        <h5>
            Home >> Case Management >> <asp:LinkButton ID="lnlAppointmentList" runat="server" OnClick="lnlAppointmentList_Click" ForeColor="#0033cc">Case List</asp:LinkButton> >> Specalities Consultant Closed Appointment List </h5>
         ...
         <asp:MultiView ID="SpecialistConultantApointmentView" runat="server">
             <asp:View ID="View" runat="server">
                 ...
                 <div class="form-group" style="padding:10px; padding-top:20px; margin-top:40px;  border:3px solid #e1e1e1; border-bottom-style:none; border-left-style:none; border-right-style:none; overflow:auto;">
                     <telerik:RadGrid ID="rgvSpecialistConsultanntClosedAppointmentDetails" runat="server" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" 
                         BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableTheming="true" 
                         HeaderStyle-BackColor="#113d7a" HeaderStyle-ForeColor="White" OnItemCommand="rgvSpecialistConsultanntClosedAppointmentDetails_ItemCommand" OnNeedDataSource="rgvSpecialistConsultanntClosedAppointmentDetails_NeedDataSource"
                         OnPageIndexChanged="rgvSpecialistConsultanntClosedAppointmentDetails_PageIndexChanged" Skin="Bootstrap">
