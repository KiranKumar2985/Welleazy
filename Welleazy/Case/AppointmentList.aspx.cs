...
namespace Welleazy.Case
{
    public partial class AppointmentList : System.Web.UI.Page
    {
        ...
        public void LoadAppointmentDetails()
        {
            ...
            Bal BusinessAccessLayer = new Bal();
            dtLoadAppointmentDetails = BusinessAccessLayer.LoadAppointmentDetails(Convert.ToInt32(Session["EmployeeRefId"]), 0, Convert.ToInt32(Session["LoginType"]), Convert.ToInt32(Session["CorporateId"]));
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            if (Session["EmployeeRefId"].Equals("0") && Session["LoginType"].Equals("0") && Session["CorporateId"].Equals("0"))
            {
                MainQuery = "Select APT.AppointmentId,CD.CaseEntryDatetime,APT.CustomerProfile,MCP.Description,APT.CaseRefId,APT.CaseId,APT.CaseStatus,MCS.CaseStatusName, " +
                                ...
                                "MCD.CorporateName,Format(AppointmentDateTime, 'dd-MM-yyyy hh:mm tt')AppointmentDateTime,CD.EmployeeMobileNo," +
                                ...
                                "VideographyDone,CD.AssignedExecutive,TU.name,Format(AppointmentScheduleDate, 'dd-MM-yyyy hh:mm tt')AppointmentScheduleDate,MLD.DisplayName as ScheduledBy, " +
                ...
                ConditionQuery = " and APT.CaseStatus not in (28) and APT.ReportStatus not in (3) order by AppointmentId desc";
            }
            else if(!Session["EmployeeRefId"].Equals("0") && Session["LoginType"].Equals("1") && !Session["CorporateId"].Equals("0"))
            {
                ...
                ConditionQuery = " and APT.CaseStatus not in (28) and APT.ReportStatus not in (3) and MCD.CorporateId=" + Session["CorporateId"] + " order by AppointmentId desc";
            }
            else
            {
                MainQuery = "Select APT.AppointmentId,CD.CaseEntryDatetime,APT.CustomerProfile,MCP.Description,APT.CaseRefId,APT.CaseId,APT.CaseStatus,MCS.CaseStatusName, " +
                ...
                ConditionQuery = " and APT.CaseStatus not in (28) and APT.ReportStatus not in (3) and CD.EmployeeRefId=" + Session["EmployeeRefId"] + " and MCD.CorporateId=" + Session["CorporateId"] + " order by AppointmentId desc";
            }
        ...
        public void LoadAppointmentDetailById()
        {
            ...
            {
                lblCheckAppointmentStatus.Text = dtAppointmentDetails.Tables[0].Rows[0]["AppointmentStatus"].ToString();
            }
        }
        ...
        protected void rgAppointmentDetails_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("EditRow"))
            {
                try
                {
                    ...
                    if(lblCheckAppointmentStatus.Text=="2")
                    {
            ...
            if (e.CommandName.Equals("ShowContactDetails"))
            {
                try
                {
                    ...
                    {
                        llTestAppointmentRefId.Text = lblAppointmentId.Text;
                        ...
                        TextAppointmentDateTime.Text = dtCaseDetails.Tables[0].Rows[0]["AppointmentDateTime"].ToString();
                        TextAppointmentStatus.Text = dtCaseDetails.Tables[0].Rows[0]["AppointmentDescription"].ToString();
                        TextMobileNo.Text = dtCaseDetails.Tables[0].Rows[0]["EmployeeMobileNo"].ToString();
                        TextDcName.Text = dtCaseDetails.Tables[0].Rows[0]["DCName"].ToString();
                        TextVideography.Text = dtCaseDetails.Tables[0].Rows[0]["VideographyDone"].ToString();
        ...
        protected void rgAppointmentDetails_ItemDataBound(object sender, GridItemEventArgs e)
        {
            foreach (GridDataItem item in rgAppointmentDetails.MasterTableView.Items)
            {
                ...
                else if (lblAppointmentStatus.Text == "Scheduled")
                {
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_CorporateName");
        ...
        //    SqlParameter paramCaseStatus = new SqlParameter("@CaseStatus", rcbCaseStatus.SelectedValue);
        //    SqlParameter paramApplicationNo = new SqlParameter("@ApplicationNo", txt_ApplicationNo.Text.Trim());
        //    SqlParameter paramCaseId = new SqlParameter("@CaseId", txt_CaseId.Text.Trim());
        //    SqlParameter paramBranch = new SqlParameter("@Branch", rcbBranch.SelectedValue);
        //    SqlParameter paramCity = new SqlParameter("@City", rcbCitySearch.SelectedValue);
        //    SqlParameter paramCaseOwnerName = new SqlParameter("@CaseOwnerName", txt_EmployeeName.Text.Trim());
        //    SqlParameter paramAppointmentStatus = new SqlParameter("@AppointmentStatus", rcbAppointmentStatus.SelectedValue);

        //    cmdFetchAppointmentList.Parameters.Add(paramCorporateName);
        //    cmdFetchAppointmentList.Parameters.Add(paramCaseStatus);
        //    cmdFetchAppointmentList.Parameters.Add(paramApplicationNo);
        //    cmdFetchAppointmentList.Parameters.Add(paramCaseId);
        //    cmdFetchAppointmentList.Parameters.Add(paramBranch);
        //    cmdFetchAppointmentList.Parameters.Add(paramCity);
        //    cmdFetchAppointmentList.Parameters.Add(paramCaseOwnerName);
        //    cmdFetchAppointmentList.Parameters.Add(paramAppointmentStatus);



        //    SqlDataAdapter daFetchAppointmentList = new SqlDataAdapter(cmdFetchAppointmentList);
        //    DataTable dtFetchAppointmentList = new DataTable();

        //    daFetchAppointmentList.Fill(dtFetchAppointmentList);

        //    if (dtFetchAppointmentList != null && dtFetchAppointmentList.Rows.Count > 0)
        //    {
        //        rgAppointmentDetails.DataSource = dtFetchAppointmentList;
        //        rgAppointmentDetails.DataBind();
        //    }
        //    else
        //    {
        //        rgAppointmentDetails.DataSource = null;
        //        rgAppointmentDetails.DataBind();
        //    }
        //}
        //public void SearchCaseStatus()
        //{
        //    SqlConnection con = new SqlConnection(conStr);
        //    con.Open();
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_CaseStatus");
        ...
        //        if (CaseStatus == "")
        //        {
        //            CaseStatus = rcbCaseStatus.CheckedItems[i].Text.Trim();
        //        }
        //        else
        //        {
        //            CaseStatus += "," + rcbCaseStatus.CheckedItems[i].Text.Trim();
        ...
        //    SqlParameter paramCorporateName = new SqlParameter("@CorporateId", rcbClientName.SelectedValue);
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_Application");
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_CaseId");
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_Branch");
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_City");
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_CaseOwner");
        ...
        //    SqlCommand cmdFetchAppointmentList = new SqlCommand("proc_SearchAppointmentList", con);
        //    cmdFetchAppointmentList.CommandType = CommandType.StoredProcedure;
        //    cmdFetchAppointmentList.Parameters.AddWithValue("@Action", "FETCH_AppointmentStatus");
        ...
        //protected void txt_ApplicationNo_TextChanged(object sender, EventArgs e)
        //{
        //    SearchApplicationNo();
        //}

        //protected void rcbAppointmentStatus_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        //{
        ...
        //protected void txt_EmployeeName_TextChanged(object sender, EventArgs e)
        //{
        //    SearchCaseOwner();
        //}

        //protected void rcbBranch_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        //{
        //    SearchBranchList();
        //}

        //protected void rcbCaseStatus_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        //{
        //    SearchCaseStatus();
        //}

        //protected void rcbCitySearch_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        //{
        //    SearchCityList();
        //}
    }
