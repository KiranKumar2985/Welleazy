<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="ConsultationCaseAppointmentDetails.aspx.cs" Inherits="Welleazy.Appointment.ConsultationCaseAppointmentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<asp:UpdatePanel ID="upEConsultant" runat="server">
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
      <h5>
            <asp:LinkButton ID="LinkHome" runat="server" PostBackUrl="~/Home.aspx"  ForeColor="#0033cc">Home</asp:LinkButton> >> Consultation Case Management >> Consultation Case Appointment List
             <span style="float:right; font-size:small;">
                    <asp:LinkButton ID="Linkspl1" runat="server" PostBackUrl="~/Appointment/ConsultationCaseAppointmentDetailsHistory.aspx" ForeColor="#0033cc"><b><i class="glyphicon glyphicon-plus"></i></b> Consultation Case Appointment History</asp:LinkButton> 
                 </span>
        </h5>
         <div class="line">
         </div>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              <div class="col-lg-3 col-sm-6">
                ...
                <label>Appointment Status </label>
                        <div class="selector">
                            <telerik:RadComboBox ID="cmbAppointmentStatusSearch" Filter="Contains" CheckBoxes="true" RenderMode="Lightweight" CssClass="Combo" AppendDataBoundItems="true" runat="server">
                                <Items>
            ...
            <div class="col-lg-3 col-sm-6">
             ...
             <div class="row">
                 ...
                 <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            <telerik:RadDateRangePicker ID="rdrpFollowupdate" RenderMode="Lightweight" StartDatePicker-DateInput-DateFormat="dd-MM-yyyy" EndDatePicker-DateInput-DateFormat="MM-dd-yyyy" runat="server" ></telerik:RadDateRangePicker>
             ...
             <div class="col-lg-3 col-sm-6">
                        <label>Case Receive Date (DD-MM-YYYY) </label>
                        <div class="selector">
                            <telerik:RadDateRangePicker ID="rdrpCaseReceivedate" RenderMode="Lightweight" StartDatePicker-DateInput-DateFormat="dd-MM-yyyy" EndDatePicker-DateInput-DateFormat="MM-dd-yyyy" runat="server"></telerik:RadDateRangePicker>
                            </div>
               ...
               <asp:Button ID="btnGo" runat="server" CssClass="Login_btn btn" BackColor="#113d7a" ForeColor="white" BorderStyle="None" OnClick="btnGo_Click" Text="Go" Width="100" />
                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnAdvanced" runat="server" CssClass="Login_btn btn" BackColor="#113d7a" ForeColor="white" BorderStyle="None" Text="Advanced Search" OnClick="btnAdvanced_Click" Width="200" />
                 ...
                 <div class="form-group" style="padding:10px; padding-top:20px; margin-top:40px;  border:3px solid #e1e1e1; border-bottom-style:none; border-left-style:none; border-right-style:none; overflow:auto;">
                     <telerik:RadComboBox ID="cmbExport" RenderMode="Lightweight" CssClass="Combo_Export" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbExport_SelectedIndexChanged" >
                          <Items>
                              <%--<telerik:RadComboBoxItem Value="0" Text="-Select-" />--%>
                              <%--<telerik:RadComboBoxItem Value="1" Text="PDF" />--%>
                              
                              <telerik:RadComboBoxItem  Value="1" Text="CSV"/>
                 ...
                 <div class="container"   style="overflow:auto">
                     <div class="form-group">
                         ...
                         OnPageIndexChanged="rgvConsultantCaseAppointmentDetails_PageIndexChanged" OnItemDataBound="rgvConsultantCaseAppointmentDetails_ItemDataBound" Skin="Bootstrap">
                         <MasterTableView AllowMultiColumnSorting="true" AllowSorting="true" NoDetailRecordsText="No Records to Display">
                             <Columns>
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Case Id" SortExpression="CaseId">
                                     <ItemTemplate>
                                         <asp:Label ID="lnkCaseId" runat="server" CausesValidation="false" CommandArgument="<%# (Container.ItemIndex).ToString() %>"  Text='<%# DataBinder.Eval(Container.DataItem, "CaseId")%>'></asp:Label>
                                        <%-- <asp:Label ID="lblConsultantCaseDetailsId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ConsultationCaseDetailsId")%>' Visible="false"></asp:Label>
                                         <asp:Label ID="lblConsultationAppointmentDetailsId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ConsultationCaseAppointmentDetailsId")%>' Visible="false"></asp:Label>--%>
                                     </ItemTemplate>
                                 </telerik:GridTemplateColumn>
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="MER File">
                                        <ItemTemplate>
                                         <asp:ImageButton ID="lnkConsultationCaseMERFile" runat="server" ImageUrl="~/images/edit-icon (1).png" Height="20" Width="20" 
                                             CommandArgument="<%# (Container.ItemIndex).ToString() %>" CommandName="OpenMERFile" />
                                            <asp:Label ID="lblConsultantCaseDetails_Id" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ConsultationCaseDetailsId")%>' Visible="false"></asp:Label>
                                         <asp:Label ID="lblConsultationAppointmentDetails_Id" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ConsultationCaseAppointmentDetailsId")%>' Visible="false"></asp:Label>
                                            <asp:Label ID="lblAppointmentStatusId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "AppointmentStatusId")%>' Visible="false"></asp:Label>
                                     </ItemTemplate>
                                 </telerik:GridTemplateColumn>
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Case Status" SortExpression="CaseStatus">
                                        <ItemTemplate>
                                         <asp:Label ID="lblCaseStatus" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CaseStatus")%>'>
                                            ...
                                            <asp:Label ID="lblCaseStatusId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "Case_StatusId")%>'>

                                                    </asp:Label>
                                            <asp:Label ID="lblAppointmentCaseStatusId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "AppointmentStatusId")%>'>
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Assigned Executive" SortExpression="AssignedExecutive">
                                        <ItemTemplate>
                                         <asp:Label ID="lblAssignedExecutive" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "AssignedExecutive")%>'>
                                                    </asp:Label>
                                     </ItemTemplate>
                                 </telerik:GridTemplateColumn>
           ...
           <h4>Case Management </h4>
            ...
            <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="rfvExecutive" runat="server" ControlToValidate="cmbAssignExecutive" ForeColor="Red" ErrorMessage="Please Select Status" Enabled="false" InitialValue="Select Executive"></asp:RequiredFieldValidator>
                         </div>
                    </div>
            <div class="col-lg-3 col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="col-lg-3 col-sm-6">
                         ...
                         <div class="selector">
                             <telerik:RadComboBox ID="cmbAppointmentStatus" runat="server" AppendDataBoundItems="true" CssClass="Combo" AutoPostBack="true" Filter="Contains" OnSelectedIndexChanged="cmbAppointmentStatus_SelectedIndexChanged" RenderMode="Lightweight" ValidationGroup="Case">
                                 <Items>
                ...
                <div class="col-lg-3 col-sm-6">
                         ...
                         <div class="selector">
                             <telerik:RadComboBox ID="cmbCaseStatus" runat="server" AppendDataBoundItems="true" CssClass="Combo" Filter="Contains" RenderMode="Lightweight" ValidationGroup="Test">
                                 <Items>
                                     <telerik:RadComboBoxItem Text="Select Case Status" Value="0" />
                                     <%--<telerik:RadComboBoxItem Text="Scheduled" Value="1" />
                                     <telerik:RadComboBoxItem Text="Completed" Value="2" />
                                     <telerik:RadComboBoxItem Text="Re-Schedule" Value="3" />
                                     <telerik:RadComboBoxItem Text="Cancelled" Value="4" />--%>
                             ...
                             <asp:RequiredFieldValidator ID="rfvCaseStatus" runat="server"  ControlToValidate="cmbCaseStatus" Enabled="true" ValidationGroup="Test" ErrorMessage="Please Select Status" ForeColor="Red" InitialValue="Select Case Status"></asp:RequiredFieldValidator>
                         </div>
                     </div>
            </div>
