<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportRemark.aspx.cs" Inherits="Welleazy.Appointment.ReportRemark" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; ">
        ...
        <div style="background-color:#f6f5f5; padding:15px; border-radius:3px;">
            ...
            <telerik:RadGrid ID="rgvReportRemarkDetails" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnItemCommand="rgvReportRemarkDetails_ItemCommand" OnNeedDataSource="rgvReportRemarkDetails_NeedDataSource" OnPageIndexChanged="rgvReportRemarkDetails_PageIndexChanged" Skin="Bootstrap">
                       <ClientSettings>
                               ...
                               <Columns>
                                   ...
                                   <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Comments" SortExpression="ActionPerformed">
                                       <ItemTemplate>
                                           <asp:Label ID="lblReportRemark" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ActionPerformed")%>'>
                                                        </asp:Label>
                                       </ItemTemplate>
                                   </telerik:GridTemplateColumn>
        ...
        <div style="background-color:#f6f5f5; padding:15px; border-radius:3px;">
            ...
            <span style="overflow:auto; width:100%;">
            <telerik:RadGrid ID="rgvAppointmentRemarkDetails" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnItemCommand="rgvAppointmentRemarkDetails_ItemCommand" OnNeedDataSource="rgvAppointmentRemarkDetails_NeedDataSource" OnPageIndexChanged="rgvAppointmentRemarkDetails_PageIndexChanged" Skin="Bootstrap" >
                       <ClientSettings>
        ...
        <div style="background-color:#f6f5f5; padding:15px; border-radius:3px;">
            Case Logs<br /><br />
            <span style="overflow:auto; width:100%;">
            <telerik:RadGrid ID="rgvCaseRemarkDetails" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnItemCommand="rgvCaseRemarkDetails_ItemCommand" OnNeedDataSource="rgvCaseRemarkDetails_NeedDataSource" OnPageIndexChanged="rgvCaseRemarkDetails_PageIndexChanged" Skin="Bootstrap" >
                       <ClientSettings>
