<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.Master" CodeBehind="EConsultantCaseDetails.aspx.cs" Inherits="Welleazy.Case.EConsultantCaseDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<asp:UpdatePanel ID="upEConsultant" runat="server">
     ...
     <div class="form-group" style="background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none; margin-bottom:250px;">
         ...
         <asp:MultiView runat="server" ID="EConultantView">
             ...
             <div class="col-md-3">
               ...
               <asp:Button ID="btnGo" runat="server" CssClass="Login_btn btn" BackColor="#113d7a" ForeColor="white" BorderStyle="None" OnClick="btnGo_Click" Text="Go" Width="100" />
                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnAdvanced" runat="server" CssClass="Login_btn btn" BackColor="#113d7a" ForeColor="white" BorderStyle="None" Text="Advanced Search" OnClick="btnAdvanced_Click" Width="200" />
                  ...
                  <telerik:RadGrid ID="rgvEConsultancyCaseDetails" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" 
                      BorderWidth="1px" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" EnableTheming="true"
                      OnItemCommand="rgvEConsultancyCaseDetails_ItemCommand" OnNeedDataSource="rgvEConsultancyCaseDetails_NeedDataSource" OnPageIndexChanged="rgvEConsultancyCaseDetails_PageIndexChanged"
                           ...
                           <Columns>
                               <telerik:GridTemplateColumn HeaderText="Schedule Appointment" >
                                   <ItemTemplate>
                                       ...
                                       <asp:Label ID="lbl_EConsultantCaseDetailsId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "EConsultantCaseDetailsId")%>' Visible="false"></asp:Label>
                                   </ItemTemplate>
