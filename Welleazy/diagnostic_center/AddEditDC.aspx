<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddEditDC.aspx.cs" Inherits="Welleazy.diagnostic_center.AddEditDC" EnableEventValidation="false" EnableSessionState="True" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group" style="height:auto; background-color: white; padding: 3px; margin-top: -30px; border: 5px solid #0869b1; border-bottom-style: none; border-left-style: none; border-right-style: none;">
        <h4>Update Service Provider Details</h4>
        ...
        <asp:Label ID="lbldc_id" runat="server" Visible="false" ></asp:Label><br />
        <asp:Label ID="lbl_dc_id" runat="server" Visible="false"></asp:Label>    
         <div class="line"></div>
        <%--<span style="padding:7px; background-color:#0869b1; color:white; text-align:center; width:100%; margin-top:15px;">Service Provider Details</span>--%>
        <div id="TypeOfProvider" runat="server" visible="true" class="form-group" style="padding-left:10px; padding-right:10px;">
            <h5>Type of Provider</h5>
            <hr />
            <div class="col-md-3">
                        <label>Type of Provider  </label>
                        <div class="selector">
                            <telerik:RadComboBox ID="DDL_Typeofprovider" runat="server" RenderMode="Lightweight" CssClass="Combo" AutoPostBack="true" AppendDataBoundItems="true" Filter="Contains" OnSelectedIndexChanged="DDL_Typeofprovider_SelectedIndexChanged">
                                <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="Provider Type" />
                                    </Items>
                               
                            </telerik:RadComboBox>
                            <asp:Label ID="lblsptoken_id" runat="server" Visible="false"></asp:Label>
                         </div>
                    </div>
            <div class="col-md-3">
...
<div class="col-md-3"></div>
        ...
        <div id="ProviderManpower" runat="server" visible="true" class="form-group" style="padding-left:10px; padding-right:10px; margin-top:20px;">
            <h5>Provider Manpower & Staffing</h5>
            <hr />
            <div class="col-md-3">
        ...
        <div id="Depart1" runat="server" visible="false" class="form-group" style="padding-left:10px; padding-right:10px; margin-top:240px; overflow:auto;">
            <table style="border:1px solid #f2f1f1; padding:10px;">
                ...
                <tr>
                    ...
                    <td class="table_space">
                        <asp:TextBox ID="txt_cno9" runat="server" TextMode="SingleLine" class="form-control required" MaxLength="10" ValidationGroup="SaveFrame"></asp:TextBox>
        ...
        <div id="ProviderServices" runat="server" visible="true" class="form-group" style="padding-left:10px; padding-right:10px; margin-top:30px;">
            ...
            <div class="col-md-3">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_Ambulance" runat="server" ControlToValidate="DDL_Ambulance" ForeColor="Red" ErrorMessage="Please Select Ambulance Option" Enabled="true"  ValidationGroup="SaveFrame" InitialValue="Select"></asp:RequiredFieldValidator>
                         </div>
                    </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                        ...
                        <div class="selector">
                           ...
                           <%-- <asp:RequiredFieldValidator ID="RequiredField_Health" runat="server" ControlToValidate="DDL_Health" ForeColor="Red" ErrorMessage="Please Select Health Check Up" Enabled="true"  ValidationGroup="SaveFrame" InitialValue="Select"></asp:RequiredFieldValidator>--%>
                         <br /><br /></div>
                    </div>
            <div class="col-md-3">
                        <label>No. Of BLS Ambulances </label>
                        <div class="selector">
                             <asp:TextBox ID="txt_BLSambulance" runat="server" TextMode="Number" MaxLength="3" class="form-control required"></asp:TextBox>
                         </div>
                    </div>
            <div class="col-md-3">
        ...
        <div id="Specialtiesavail" runat="server" visible="true" class="form-group" style="padding-left:10px; padding-right:10px; margin-top:200px;">
       ...
       <%-- <div id="ListOfDoctor" runat="server" visible="true" class="form-group" style="padding:10px; margin-top:320px; background-color:white; display:none;">
        ...
        <%--    <div class="col-md-4">
            ...
            <div class="col-md-4">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_CancelCheque" runat="server" ErrorMessage="Mandatory Field" Enabled="true" ControlToValidate="FileUploadCancelCheque" ForeColor="Red" ValidationGroup="SaveFrame" ></asp:RequiredFieldValidator>
                            <asp:Label ID="lblUpload19" runat="server" ForeColor="#006666"></asp:Label>
                            <%--<asp:TextBox ID="txtUpload19" runat="server" TextMode="SingleLine" class="form-control required" Visible="false"></asp:TextBox>--%>
                            <asp:Image ID="Image19" runat="server" Height="200px" Width="150px" />
                         </div>
                    </div>
            <%--<div class="col-md-4">
        ...
        <div id="SaveContinue" runat="server" visible="true" class="form-group" style="padding-left:10px; padding-right:10px; margin-top:240px; background-color:white; text-align:center;">
            <asp:Button ID="btnUpdate" BackColor="#113d7a" ForeColor="white" BorderStyle="None" runat="server" Text="Update" type="submit" value="Update" CssClass="Login_btn btn" OnClick="btnUpdate_Click" ValidationGroup="SaveFrame" />&nbsp;&nbsp;
            <asp:Button ID="btnUploadDoc" BackColor="#113d7a" ForeColor="white" BorderStyle="None" runat="server" Text="Next - Upload Documents" value="Next - Upload Documents" CssClass="Login_btn btn" OnClick="btnUploadDoc_Click"  ValidationGroup="SaveFrame" />
            <br /><asp:Label ID="lblUpdate" runat="server" ></asp:Label>
        </div>
        <div id="UploadDocs" runat="server" visible="false" class="form-group" style="padding:10px;">
            ...
            <div class="form-group" style="margin-top:50px;">
                ...
                <asp:Button ID="btnUploadnow" BackColor="#113d7a" ForeColor="white" OnClientClick="ValidateFile2()" BorderStyle="None" runat="server" Text="Upload Now" type="submit" value="Upload Now" CssClass="Login_btn btn" OnClick="btnUploadnow_Click"/><br />
        ...
        <div id="DocumentUpload" runat="server" visible="false" class="form-group" style="padding:10px;">
            ...
            <h4>Document Upload </h4><span class="mandatory"> (Only .png |.jpg |.jpeg files allowed with size below 1 MB) </span>
            
            <div class="form-group" style="padding:20px; margin-top:0px; border-radius:4px; border:1px solid #242424;">
            
            <div class="form-group" style="margin-top:10px; height:300px;">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image3" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image6" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
                </div>
            <div class="form-group" style="margin-top:10px; height:300px;" >
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image7" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image8" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
                </div>
            <div class="form-group" style="margin-top:10px; height:300px;">
            <div class="col-md-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredField_NNIJOther" runat="server" ErrorMessage="Mandatory Field" ControlToValidate="FileUploadNNIJOther" ForeColor="Red"></asp:RequiredFieldValidator>  
                             ...
                             <asp:Image ID="Image9" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:Label ID="lblUpload10" runat="server" ForeColor="#006666"></asp:Label><br />
                             <asp:Image ID="Image10" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
                </div>
            <div class="form-group" style="margin-top:10px; height:300px;">
            <div class="col-md-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:Label ID="lblUpload11" runat="server" ForeColor="#006666"></asp:Label><br />
                             <asp:Image ID="Image11" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image12" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
                </div>
            <div class="form-group" style="margin-top:10px; height:300px;">
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image13" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image14" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            </div>
            <div class="form-group" style="margin-top:10px; height:300px;">
            <div class="col-md-6">
                        ...
                        <div class="selector">
                            ...
                            <asp:Label ID="lblUpload15" runat="server" ForeColor="#006666"></asp:Label><br />
                             <asp:Image ID="Image15" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Label ID="lblUpload16" runat="server" ForeColor="#006666"></asp:Label>
                             <asp:Image ID="Image16" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            </div>
            <div class="form-group" style="margin-top:10px; height:300px;">   
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image17" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="selector">
                             ...
                             <asp:Image ID="Image18" runat="server" Height="200px" Width="150px" />
                         </div>
            </div>
                </div>                 
            <div class="form-group" runat="server" style="margin-top:80px;">
                ...
                <asp:Label ID="lblCenterStatus" runat="server" Visible="false"></asp:Label>
            </div>
