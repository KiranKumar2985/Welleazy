...
public class ExcelHelper
{
    ...
    private static string getWorkbookTemplate()
    {
        ...
        sb.Append("ss:Format=\"dd/mm/yyyy;@\"/>\r\n </Style>\r\n		<Style ss:ID=\"s28\">\r\n");
    ...
    public static string ToExcel(DataSet dsInput, string filename, HttpResponse response)
    {
    ...
    public static void ToExcelDownloadSamePage(DataSet dsInput, string filename, HttpResponse response)
    {
        var excelXml = GetExcelXml(dsInput, filename);
