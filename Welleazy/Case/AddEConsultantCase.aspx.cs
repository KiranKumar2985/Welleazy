...
{
    public partial class AddEConsultantCase : System.Web.UI.Page
    {
        ...
        public void GenearateEConsultancyCaseId()
        {
            Bal BusinessAccessLayer = new Bal();
            DataTable dtCaseId = new DataTable();
            Int32 CaseId = 0;

            dtCaseId = BusinessAccessLayer.GenearateEConsultancyCaseId();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnSave.Text.Equals("Save"))
                {
                    ...
                    BusinessAccessLayer.InsertUpdateEConsultantCaseDetails(0, txtCaseId.Text.Trim(), Convert.ToInt32(cmbBranch.SelectedValue), dtpCaseEntryDate.DateInput.SelectedDate.Equals(null) ? nul : dtpCaseEntryDate.DateInput.SelectedDate.Value,
                        ...
                        Convert.ToInt32(cmbDoctorQualification.SelectedValue), Convert.ToInt32(cmbCaseStatus.SelectedValue), dtpFollowUp.DateInput.SelectedDate.Equals(null) ? nul : dtpFollowUp.DateInput.SelectedDate.Value, txtRemarks.Text.Trim(),
                        1, out IsDataExists);
                    if (IsDataExists == "1")
                    {
                ...
                {
                    BusinessAccessLayer.InsertUpdateEConsultantCaseDetails(Variables.EConsultantCaseDetailsId, txtCaseId.Text.Trim(), Convert.ToInt32(cmbBranch.SelectedValue), dtpCaseEntryDate.DateInput.SelectedDate.Equals(null) ? nul : dtpCaseEntryDate.DateInput.SelectedDate.Value,
                        Convert.ToInt32(cmbAssignExecutive.SelectedValue), Convert.ToInt32(cmbCaseMode.SelectedValue), dtpCaseRecordedDateTime.DateInput.SelectedDate.Equals(null) ? nul : dtpCaseRecordedDateTime.DateInput.SelectedDate.Value,
                        Convert.ToInt32(cmbCorporateName.SelectedValue), Convert.ToInt32(cmbCorporateBranchId.SelectedValue), Convert.ToInt32(cmbServicesOffered.SelectedValue), txtEmployeeName.Text.Trim(),
                        txtMobileNo.Text.Trim(), Convert.ToInt32(cmbGender.SelectedValue), txtEmployeeEmailId.Text.Trim(), NoOfFreeConsultation, NoofConsultationRecorded, Convert.ToInt32(cmbConsultationType.SelectedValue)
                        , Convert.ToInt32(cmbCaseType.SelectedValue), Convert.ToInt32(cmbPaymentType.SelectedValue), Convert.ToInt32(cmbCaseFor.SelectedValue), Convert.ToInt32(cmbCustomerProfile.SelectedValue),
