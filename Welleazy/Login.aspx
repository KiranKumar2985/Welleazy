<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginTest.aspx.cs" Inherits="Welleazy.LoginTest" %>
...
<form runat="server" id="form1" class="form-signin float-left">
  ...
  <br />
	...
	<div class="row">
	<div class="mb-2 col-6"><a href="#" class="clrgray"><asp:LinkButton ID="LinkGenerateOTP" runat="server" CausesValidation="false" OnClick="LinkGenerateOTP_Click" Visible="true"> Generate OTP</asp:LinkButton></a></div>
...
<label class="custom-control-label clrgray" for="customCheck1" style="font-size:small;">I agree to Welleazy’s Terms of Service and Privacy Policy</label>
        ...
        <asp:Button ID="btnLogin" Width="330" BackColor="#ff9900" ForeColor="white" BorderStyle="None" runat="server" Text="Sign in" type="submit" value="Sign in" CssClass="Login_btn btn" OnClick="btnLogin_Click" Visible="true" ValidationGroup="Login"/><br />
            ...
            <asp:Label ID="lblOTPText" runat="server" Visible="false" Text="OTP Expires in :"></asp:Label>
            <asp:Label ID="lblOTPExpiryTime" Visible="false" runat="server"></asp:Label>
            <asp:Label ID="Label1" runat="server" ForeColor="Green" Visible="false" ></asp:Label>
            <span runat="server" id="Attempt" style="color:red;" visible="false">Remaining attempt:  <asp:Label ID="li_attempt" runat="server" ForeColor="Red" Visible="true" ></asp:Label></span><br />
    ...
    <asp:HiddenField ID="timer" runat="server"  />
</form>
    ...
    //alert(countDownDateValue);
        ...
        var x = setInterval(function () {
            ...
            document.getElementById("lblOTPExpiryTime").innerHTML = displayhours + ":" + displayminites + ":" + displayseconds;
            ...
            if (distance < 0) {
                ...
                //}
                //else {
                document.getElementById("LinkGenerateOTP").innerHTML = "Re Generate OTP";
              
                

                //$('.LinkGenerateOTP').attr('disabled', '');

                //document.getElementById("btnLogin").click();
                //document.getElementById("LinkGenerateOTP").visibility=true;
                
                
                //document.getElementById("LinkGenerateOTP").visibility=false;
                //}
